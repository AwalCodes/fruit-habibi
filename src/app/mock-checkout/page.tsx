...
function MockCheckoutContent() {
  ...
  useEffect(() => {
    if (!authLoading && !user) {
      router.push('/login?redirect=/mock-checkout');
      return;
    }
  ...
  const handlePaymentSuccess = (orderId: string) => {
    router.push(`/orders/${orderId}?success=true&mock=true`);
  };
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-900 via-emerald-900 to-black">
        <div className="text-center">
          ...
          <div className="text-lg text-emerald-200">Loading mock checkout...</div>
        </div>
      </div>
    );
  }
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-900 via-emerald-900 to-black">
        ...
        >
          ...
          <h1 className="text-2xl font-bold text-white mb-4">Mock Checkout Error</h1>
