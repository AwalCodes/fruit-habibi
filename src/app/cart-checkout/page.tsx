            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-3xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-yellow-400 to-yellow-600">
                  {t('cart.cartCheckoutTitle')}
                </h1>
                <p className="text-emerald-200 mt-1">
                  {t('cart.cartCheckoutDesc')}
                </p>
              </div>
            </div>
            <button
            ...
            {cartItems.map((item, index) => (
              ...
              >
                ...
                <div className="flex-1">
                  ...
                  <p className="text-emerald-300 text-sm">{t('cart.by')} {item.seller_name}</p>
          ...
          <div className="border-t border-slate-600 pt-4">
            ...
            <div className="bg-emerald-500/10 border border-emerald-500/30 rounded-lg p-4">
              <p className="text-emerald-200 text-sm">
                💳 <strong>{t('listing.realStripePayment')}:</strong> {t('cart.stripePaymentNote')}
              </p>
            </div>
          </div>
        </div>
